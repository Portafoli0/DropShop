...
function prueba() {
    ...
    if (document.querySelector("main hr")) {
        ...
        var h2 = document.querySelector("main h2:nth-of-type(1)");        

        var buttons = document.querySelector("main .inputs");
        if (producto.Caracteristicas) {
           main.insertBefore(h2, main.children[12]);
           main.insertBefore(buttons, main.children[13])
        } else {
            main.insertBefore(h2, main.children[9]);
            main.insertBefore(buttons, main.children[10])
        }
    }
